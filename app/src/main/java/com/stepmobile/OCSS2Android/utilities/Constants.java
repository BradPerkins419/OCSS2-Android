package com.stepmobile.OCSS2Android.utilities;

public class Constants {
    // Root page
    public static String WEBAPP_URL = "https://ocssohio.com/";
    public static String WEBAPP_HOST = "ocssohio.com"; // used for checking Intent-URLs
